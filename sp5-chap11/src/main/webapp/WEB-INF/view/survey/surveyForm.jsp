...
<body>
	...
	<form method="post">
		...
		<p>
			...
			<label><input type="radio" name="responses[1]" name="Eclipse">Eclipse</label>
			<label><input type="radio" name="responses[1]" name="Intellij">Intellij</label>
			<label><input type="radio" name="responses[1]" name="Sublime">Sublime</label>
		</p>
		<p>
			3.하고 싶은 말<br/>
